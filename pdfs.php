...
$query = $db->query("SELECT * FROM resources WHERE filetype='pdf'");
...
<div class="w3-row-padding w3-padding-64 w3-container">
	<h1 class="w3-xxlarge"> PDF Resources</h1>
		...
		<?php
			while($row = $query->fetch_array()){
				echo "<li class=\"w3-padding-16\">
						...
						<span>added by ".$row['addedBy']."</span> <a href=\"pdf/".$row['id'].".".$row['filetype']."\"><i class=\"fa fa-download w3-right w3-xlarge\"></i></a>
					  </li>";
			}
		?> 
    </ul>
