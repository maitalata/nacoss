...
<div class="w3-row-padding w3-padding-64 w3-container">
	...
	<a href="change_password.php"><div class="w3-quarter w3-hover-shadow w3-hover-opacity">
	  <div class="w3-card-2 w3-container w3-center">
		  <h3>Change Password</h3><br>
		  <i class="fa fa-key w3-margin-bottom w3-text-themed-d3" style="font-size:120px"></i>
	  </div>
	</div></a>
</div>
