...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	if($data_check->emptyCheck($institution, $from, $to, $certificate)){
		if($db->query("INSERT INTO institutions(user, institutionName, fromD, toD, certificate) VALUES ('$user','$institution','$from','$to','$certificate')")){
...
<?php echo $response; ?>
	...
	<form action="" method="POST">
		<div class="w3-section">      
			<input class="w3-input" type="text" name="institution" placeholder="Institution Name">
		</div>
		<div class="w3-section">
		...
		<div class="w3-section">      
			<input class="w3-input" type="text" name="certificate" placeholder="Certificate Obtained">
		</div>
